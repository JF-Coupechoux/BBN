...
int test1=0;
double rho_0_c, m, omega_rad, omega_b, omega_phi, domega_dx, omega0_phi, omega0_b, omega0_rad, H0,omega_rad_adapt, omega_b_adapt, omega_phi_adapt, Q,omega_de, beta, alpha;
...

{
  ...
  FILE *ext;
  	...
  	val[2]= 5.e4;  	   /* valeur initiale de sigma */
  	val[3]= 1.e12; 		   /* valeur initiale de dsigma/dt */
