...
int test1=0;
double rho_0_c, m, omega_rad, omega_b, omega_phi, domega_dx, omega0_phi, omega0_b, omega0_rad, H0,omega_rad_adapt, omega_b_adapt, omega_phi_adapt, Q,omega_de, lambda;

/*---------------------------------------------------------------------------------------------------------------*/

double V_pot(double x)
{
	return 0.5*m*m*x*x+0.25*lambda*pow(x,4);
}
...

{
  ...
  FILE *ext;
  	...
  	val[2]= 8.6629188228e+03;  	   /* valeur initiale de sigma */
